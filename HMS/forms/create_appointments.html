...
<html lang="en">
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0" style="font-family: georgia; color: lightcoral;">Appointment Form</h3></div>
              <div class="col-sm-6">
              ...
              <div class="col-12">
                ...
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title" style= " color: peru; font-family: georgia;">Appointment Form</h3>
                      <button
                        type="button"
                        class="btn btn-tool"
  ...
  <div class="mb-4">
    ...
    <textarea class="form-control" id="purpose" name="purpose" rows="3" placeholder="Enter Purpose of Appointment" required></textarea>
  </div>
