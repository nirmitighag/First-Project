      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0" style="font-family: garamond; color: blueviolet;">Billing Form</h3></div>
              <div class="col-sm-6">
              ...
              <div class="col-12">
                ...
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title" style= " color: navy; font-family: garamond;">Billing Form</h3>
                      <button
                        type="button"
                        class="btn btn-tool"
                  ...
                  <div class="card-body">
                    <form action="insert_billings.php" method="POST">
  <div class="mb-3">
    <label for="billID" class="form-label">Bill ID</label>
    <input type="text" class="form-control" id="billID" name="billID" placeholder="Enter Bill ID" required />
  </div>
