      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0" style="font-family: times new roman; color: darkmagenta;">Patient Enquiry Form</h3></div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Patient Enquiry Form</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
              ...
              <div class="col-12">
                ...
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title" style= " color: deeppink;">Patient Enquiry Form</h3>
                      <button
                        type="button"
                        class="btn btn-tool"
