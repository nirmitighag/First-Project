              ...
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                   ...
                   <li class="nav-item">
                    <a href="../forms/patient.php" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>PATIENTS</p>
                    </a>
                  </li>
                  ...
                  <li class="nav-item">
                    <a href="../forms/doctors.php" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>DOCTORS</p>
                    </a>
                  </li>
                  ...
                  <li class="nav-item">
                    <a href="../forms/appointments.php" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>APPOINTMENTS</p>
                    </a>
                  </li>
                   ...
                   <li class="nav-item">
                    <a href="../forms/medicalrecords.php" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>MEDICAL RECORDS</p>
                    </a>
                  </li>
                  ...
                  <li class="nav-item">
                    <a href="../forms/billings.php" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>BILLINGS</p>
                    </a>
                  </li>
