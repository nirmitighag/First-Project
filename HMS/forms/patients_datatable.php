      ...
      <main class="app-main">
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6 text-end">
                <a href="patients_form.php" class="btn btn-primary" name="save" value="create">
                  Patient Form
                </a>
              </div>
            </div>
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-8"><h3 class="mb-0">Patient Details</h3></div>
              <div class="col-sm-4">
...
if (!$result) {
    die("Query failed: " . mysqli_error($conn)); // ❗ shows the real SQL error
}
